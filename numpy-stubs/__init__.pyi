...
# Searching methods
def argmin(a: _ArrayLike, axis: Optional[int] = ..., out: Optional[ndarray] = ...): ...
def nanargmin(a: _ArrayLike, axis: Optional[int] = ...): ...

def argmax(a: _ArrayLike, axis: Optional[int] = ..., out: Optional[ndarray] = ...): ...
...
def where(a: _ArrayLike, x: _ArrayLike = ..., y: _ArrayLike = ...) -> ndarray: ...
def searchsorted(
    a: _ArrayLike,
    v: Union[float, _ArrayLike],
    side: str = ...,
