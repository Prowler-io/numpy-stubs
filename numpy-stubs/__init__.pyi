...
class datetime64:
    ...
    def __add__(self, other: Union[int, timedelta64]) -> datetime64: ...
    @overload
    def __sub__(self, other: Union[int, timedelta64]) -> datetime64: ...
    @overload
...
# numpy can treat pretty much any Python object as an array-like object when calling methods such as
# ``np.array`` and ``np.sort``.
#
# See https://stackoverflow.com/a/40380014 for details on the support in ``np.array``.
_ArrayLike = object
...
def lexsort(keys: Union[ndarray, Tuple[Sequence, ...]], axis: int = ...) -> ndarray: ...
def argsort(
    a: _ArrayLike,
    axis: Optional[int] = ...,
    kind: str = ...,
...
def msort(a: _ArrayLike) -> ndarray: ...
def sort_complex(a: _ArrayLike) -> ndarray: ...
def partition(
    a: _ArrayLike,
...
# Searching methods
@overload
def argmin(a: _ArrayLike, axis: None = None) -> int64: ...
@overload
def argmin(a: _ArrayLike, axis: int, out: ndarray = ...) -> ndarray: ...
def nanargmin(a: _ArrayLike, axis: Optional[int] = ...): ...
@overload
def argmax(a: _ArrayLike, axis: None = None) -> int64: ...
@overload
def argmax(a: _ArrayLike, axis: int, out: ndarray = ...) -> ndarray: ...
def nanargmax(a: _ArrayLike, axis: Optional[int] = ...): ...
def argwhere(a: _ArrayLike) -> ndarray: ...
def nonzero(a: _ArrayLike) -> Tuple[ndarray, ...]: ...
def flatnonzero(a: _ArrayLike) -> ndarray: ...
@overload
def where(condition: Union[_ArrayLike, bool]) -> ndarray: ...
@overload
def where(
    condition: Union[_ArrayLike, bool], x: _ArrayLike, y: _ArrayLike
) -> ndarray: ...
def searchsorted(
    a: _ArrayLike, v: _ArrayLike, side: str = ..., sorter: Optional[_ArrayLike] = ...
): ...
def extract(condition: _ArrayLike, arr: _ArrayLike) -> ndarray: ...
def count_nonzero(a: _ArrayLike, axis: Optional[Union[int, Tuple[int, ...]]] = ...): ...
